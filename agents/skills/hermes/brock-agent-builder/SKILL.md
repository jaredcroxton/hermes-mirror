...
- `references/brisbane-council-agent-research.md` — Brisbane City Council planning framework research for building a council development agent. ArcGIS endpoints, overlay risk tiers, real property tests (Paddington vs Ashgrove brick), two-lot detection, and the four-layer build plan.
- `references/southern-downs-council-agent-research.md` — Southern Downs Regional Council research. Regional overlays (bushfire, biodiversity, mining), PDF-based planning scheme, TechnologyOne IntraMaps, and the 11 Dight Road verified facts.
- `references/council-agent-build-methodology.md` — The 7-layer methodology for building council agents. The critical transfer lesson: each council needs its own risk engine. Brisbane methodology does not transfer to regional councils. Verified council data patterns for Brisbane and Southern Downs.
