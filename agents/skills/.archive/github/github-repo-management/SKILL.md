...
## Public agent mirror / backup repositories

When the user designates a public GitHub repo as an agent mirror or reproducibility backup, treat it as a documentation and non-secret configuration repository, not a full state dump.

Good candidates to commit:
- setup notes and runbooks
- sanitized config examples
- skill/workflow docs
- reproducibility instructions
- scripts/templates that do not contain credentials

Never commit:
- `.env` files, API keys, OAuth tokens, cookies, SSH private keys, GitHub tokens
- raw private email/calendar contents or sensitive PII
